begin
  ...
  puts "Jeweler (or a dependency) not available. This is only required if you plan to package drag as a gem."
end
...
desc 'Generate documentation for the drag extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'DragExtension'
